...
## Script Metadata
- Filename: tools/bulk_process.py
- Language: Python
- Purpose: Bulk-cleans Python and text files in a directory — strips trailing whitespace from every line, ensures files end with exactly one newline, and optionally replaces tabs with spaces.
...
|-----------|-------------|---------|
| `--input`, `-i` | Directory to scan for files (required) | — |
| `--ext EXT [EXT ...]` | One or more file extensions to process | `.py` |
| `--recursive`, `-r` | Scan subdirectories recursively | `False` |
| `--expand-tabs N` | Replace tabs with N spaces per tab stop (0 = disabled) | `0` |
| `--dry-run` | Report changes without writing any files | `False` |

## Test Run Output
```
--- --help ---
usage: bulk_process.py [-h] --input INPUT [--ext EXT [EXT ...]] [--recursive]
                       [--expand-tabs N] [--dry-run]

Bulk-clean Python/text files: strip trailing whitespace and fix newlines.

options:
  -h, --help           show this help message and exit
  --input, -i INPUT    Directory to scan for files.
  --ext EXT [EXT ...]  File extensions to process (default: .py).
  --recursive, -r      Scan subdirectories recursively.
  --expand-tabs N      Replace tabs with N spaces (0 = disabled).
  --dry-run            Report changes without writing files.

--- dry-run on test_data ---
[DRY RUN] Scanning: /Users/anurag_gupta2/Downloads/hello-genai/test_data
Extensions : .py
Recursive  : False
Expand tabs: disabled
Files found: 3

  OK     constants.py
  WOULD FIX  greet.py  (3 line(s) stripped)
  WOULD FIX  math_demo.py  (3 line(s) stripped, trailing newline fixed)

Summary: 2 file(s) would be modified, 0 skipped, 1 already clean.

--- actual run on test_data ---
Scanning: /Users/anurag_gupta2/Downloads/hello-genai/test_data
Extensions : .py
Recursive  : False
Expand tabs: 4
Files found: 3
  ...
  OK     constants.py
  FIXED  greet.py  (3 line(s) stripped, 1 tab(s) expanded)
  FIXED  math_demo.py  (3 line(s) stripped, trailing newline fixed)

Summary: 2 file(s) modified, 0 skipped, 1 already clean.
...
Summary: 0 file(s) modified, 0 skipped, 3 already clean.
```
